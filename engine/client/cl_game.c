...
=============
*/
static void GAME_EXPORT pfnHookEvent( const char *filename, pfnEventHook pfn, void* pUserData )
{
	char		name[64];
	cl_user_event_t	*ev;
	int		i;
...
=============
*/
texture_t* GAME_EXPORT PM_CL_TraceTexture( int ground, const float *vstart, const float *vend )
{
